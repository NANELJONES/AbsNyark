...
return (
    ...
    className='fixed shadow w-[100vw] md:w-[50vw]  lg:w-[40vw] font-[Montserrat] right-[0px] top-[0px] md:top-[0px] md:max-w-[600px] z-[10000] bg-[rgba(0,0,0,1)] h-[auto] py-[3%] px-[20px] bg-red text-white '>
      <br/>
