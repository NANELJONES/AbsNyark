...
const delivery = () => {
  ...
  const  handleCheckout  = async()=>{
    ...
    const response = await  fetch("/api/checkout_session", {
      ...
      body: JSON.stringify({data:cartItems, delivery_fee:delivery_cost})
    })
  ...
  return (
    <div className='bg-secondary h-auto'>
     ...
     <div className='w-full h-[100vh] text-[white] bg-[#2A6243] flex justify-between max-w-[1400px] mx-auto '>
            ...
            <div className='w-full  md:w-[65%]  font-[Display] md:px-[30px] py-[1vw]   '>
            ...
            <div className='px-[20px]  flex flex-wrap    gap-[1em] 2xl:gap-[10px] w-full'>
                      ...
                      <button  className='  flex items-center justify-around w-[70%] md:w-[33.3%]  py-[1em] text-[black]  text-[1em] md:text-[0.95em] mx-[20px] md:mx-[auto] bg-[white] ml-[0px] mt-[2em]' onClick={()=>{handleCheckout()}}  >  PAYMENT </button>
